 ...
 *  default it uses OSM Nomintim, but it can be configured with a custom store
 ...
 *  
 *  * display_name - ``String`` The formatted address.
...
GeoExt.form.GeocoderComboBox = Ext.extend(Ext.form.ComboBox, {
     ...
     *  :attribute:`store` is configured, this will be ignored. Note that the
     *  :attribute:`queryParam` will be used to append the user's combo box
     ...
     *  store with a ScriptTagProxy and the url configured as :attribute:`url`
     *  property.
     */
     ...
     *  Only set if :attribute:`layer` is configured.
     */
     ...
     *  component was configured with an :attribute:`layer`.
     */
     ...
     *  Remove the location marker from the :attribute:`layer` and destroy the
     *  :attribute:`locationFeature`.
     */
     ...
     *
     *  Set the :attribute:`map` for this instance.
     */
    setMap: function(map) {
