    ...
    position: function() {
        ...
        if(this.isVisible()) {
            if (this.anchorPosition === "auto") {
                ...
                var elSize = this.el.getSize(true);
                var ancSize = this.anc.getSize(true);
                var ancLeft = parseInt(this.anc.getStyle('left'));
                var ancRight = parseInt(this.anc.getStyle('right'));

                var top = centerPx.y + mapBox.y;
                var left = centerPx.x + mapBox.x;
